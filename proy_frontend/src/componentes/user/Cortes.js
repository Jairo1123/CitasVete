...
const Cortes =() => {
  ...
  return (
    <div class="card">
      ...
      <Button sx={{ display: 'block', mt: 2 }}>       
      </Button>
      <FormControl sx={{ m: 1, minWidth: 120 }}>
        <InputLabel id="select-label">Hora</InputLabel>
        <Select name="hora" value={cortes.hora}  label="Hora"
          onChange={handleChange}>
          <MenuItem value="1:00">1:00</MenuItem>
          <MenuItem value="2:00">2:00</MenuItem>
          <MenuItem value="3:00">3:00</MenuItem>
        </Select>
        <FormHelperText>Hora del Servicio</FormHelperText>
      </FormControl><br></br>
      
      <TextField type="date" name="dia" onChange={handleChange} required /><br></br><br></br>
