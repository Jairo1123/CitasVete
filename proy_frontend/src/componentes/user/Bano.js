...
const Bano = () => {
  ...
  return (
    <div>
      ...
      <TextField name="hora" type="time" helperText="Hora del servicio" onChange={handleChange} required /><br></br>
      <TextField name="dia" type="date" helperText="Día que desea el servicio" onChange={handleChange} required /><br></br><br></br>
